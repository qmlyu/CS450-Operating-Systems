...
void runcmd(struct cmd *cmd) {
    ...
    switch (cmd->type) {
        ...
        case ' ':
            ...
            if (ecmd->argv[0] == 0)
                exit(0);
            //fprintf(stdout, "1exec not implemented\n");
        ...
        case ';':
            ...
            if(fork1() == 0)
                runcmd(lcmd->left);
            // type is ';' then parallel execution
            if (lcmd->type == ';') {
                wait(0);
            }
            runcmd(lcmd->right);
...
char * trim(char *strIn){
    ...
    while(strIn[j] == ' ')
        --j;
    char *strOut = malloc(sizeof(*strIn));
...
//Check if the last digit of the command is &
//for example:
//strIn = "ehco a; echo b&\n" return 1
//strIn = "ehco a; echo b&      \n" return 1
//strIn = "ehco a; echo b return 0
//strIn = "ehco a& echo b; return 0
